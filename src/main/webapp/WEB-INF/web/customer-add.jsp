...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="cust_name" name="cust_name">
		</div>
	</div>
...
$.ajax({
	url:"/work5/customerController/insert.do",
	data:{cust_code:$("#cust_code").val(),cust_name:$("#cust_name").val(),email:$("#email").val()},
	dataType:'json',
	type:'post',
