...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="goods_code" name="goods_code">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="goods_sum" name="goods_sum">
		</div>
	</div>
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="goods_cost" name="goods_cost">
		</div>
	</div>
...
$.ajax({
	url:"/work5/goodsController/insert.do",
	data:{goods_code:$("#goods_code").val(),goods_name:$("#goods_name").val(),goods_sum:$("#goods_sum").val(),goods_cost:$("#goods_cost").val()},
	dataType:'json',
	type:'post',
