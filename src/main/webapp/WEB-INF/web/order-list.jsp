...
<div style="margin-left:20px;">
 	<div class="text-c"> 
		<button type="button" class="btn btn-success" id="" name="" onclick="inst()"><i class="Hui-iconfont">&#xe665;</i>添加订单</button>
...
// 	    修改
	    table.on('edit(test)', function(obj){ 
    	        ...
    	        $.ajax({
    	        	url:"/work5/orderController/update.do",
		  ...
		  table.on('tool(test)', function(obj){
		    ...
		    if(obj.event === 'del'){
		      layer.confirm('真的删除行么', function(index){
		        $.ajax({
		        	url:"/work5/orderController/del.do?id="+data.id,
		        	dataType:'json',
		        	type:'post',
		        	traditional:true,
		        	success:function(data){
...
function inst() {
	layer.open({
		...
		content:'/work5/jump/orderadd.do'
	});
}
